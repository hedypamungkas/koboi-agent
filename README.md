...
- **Built-in tools**: calculator, filesystem, shell, web, memory, search, git, subagent, task, ingest, handover, media, peer (13 total — see `.claude/rules/builtin-tools.md`)
