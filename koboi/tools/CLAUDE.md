...
`asyncio.to_thread`; async tools awaited). 9 built-ins live in `builtin/` -- see
...
builtin/      9 built-in tools (calculator/filesystem/shell/web/memory/search/git/subagent/task)
```
