...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        ...
        [
            Turn(
                "What is the minimum number of users for AcmeCRM Business, and its per-user price?",
                expect_keywords=["25"],
            ),
        ],
    ),
    ...
    Scenario(
        "rag_hotel_presidential_amenities",
        "rag",
        [
            Turn(
                "What special amenities does the Presidential Suite include at Grand Plaza Hotel?",
                expect_keywords=["butler"],
            ),
        ],
    ),
    Scenario(
        ...
        [
            Turn(
                "What is the nightly pet fee at Grand Plaza Hotel and what's the weight limit?", expect_keywords=["25"]
            ),
        ],
    ),
    Scenario(
        "rag_hotel_cancellation",
        "rag",
        [
