...
class TestShippedEvalsGolden:
    async def test_evals_directory_outcomes(self):
        ...
        # Tier-2/3 live evals (19): rag_answer_correctness (5)
        # + rag_semantic_ranking (1) + rag_hybrid_ranking (1)
        # + rag_abstention_live (3) + rag_noise_faithfulness (1) + rag_hyde_recall (1)
        ...
        # Coding-harness demos (2): coding_fix (REAL edit_file) + coding_patch (REAL
        # apply_patch of a unified diff) -- mock-driven execution in a restricted
        # sandbox + test_suite scorer running the actual unittest suite (Wave 1 / 2.4).
